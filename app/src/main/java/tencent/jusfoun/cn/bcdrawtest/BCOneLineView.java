 ...
 * Description
 */
public class BCOneLineView extends View {
    ...
    public BCOneLineView(Context context) {
        super(context);
        this.context = context;
        initView();
    }

    public BCOneLineView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        initView();
    }

    public BCOneLineView(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (count >= 0) {
                    ...
                    if (count != 0) {
                        ...
                        if (count < p0.size()) {
                            BCOneLineView.this.count = count;
                            lineLeftStart();
                        } else {
                            BCOneLineView.this.count = count;
                            lineRightStart();
